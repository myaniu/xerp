...
<script src="${base}/res/js/validation/jquery.validate.js" type="text/javascript" charset="utf-8"></script>
<script src="${base}/res/js/validation/jquery.validate.methods.js" type="text/javascript" charset="utf-8"></script>
				...
				<tr class="roleList">
					...
					<#if isEditAction>
						<#list allRoleList as role>
							<label>
								<input type="checkbox"  class="required" name="roleIDs" value="${role.id}"
