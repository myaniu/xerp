...
<form action="${base}/erp/apply/applyproductdetail/add" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
					...
					<table class="list nowrap itemDetail" addButton="新建" width="100%">
						<thead>
							<tr>
								...
								<th type="lookup" name="items[#index#].product.name" lookupGroup="items[#index#].product" lookupUrl="${base}/erp/basic/product/list_oneLookup"  size="12" fieldClass="required">产品名称</th>
